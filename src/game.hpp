...
private:
	...
	Fixed collision_depth_fraction( const Ball &, const Block &, Fixed &order, Fixed &revert_x, Fixed &revert_y, bool &hit_x, bool &hit_y, Fixed &edge_dist_x, Fixed &edge_dist_y ) const;
